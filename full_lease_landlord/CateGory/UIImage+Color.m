...
/*** 改变image的颜色 ***/
- (UIImage *) imageWithChangeTintColor:(UIColor *)tintColor
{
 ...
 *  @return 渐变色的UIImage
 */
+ (UIImage *_Nullable)imageWithGradientColor:(NSArray *)colors andRect:(CGRect)bounds  andGradientType:(int)gradientType {
