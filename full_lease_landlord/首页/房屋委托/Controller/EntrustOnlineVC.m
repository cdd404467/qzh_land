...
@implementation EntrustOnlineVC
...
- (void)onlineEntrust {
    NSDictionary *dict = @{@"name":_nameTF.text,
                           @"phone":_phoneTF.text,
                           @"usertype":@1,
                           @"currentUserId":User_Id
    };
    DDWeakSelf;
    [NetTool postRequest:URLPost_Online_Entrust Params:dict Success:^(id  _Nonnull json) {
        if (JsonCode == 200) {
            [CddHud showTextOnly:@"委托成功" view:self.view];
